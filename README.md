...
In this project, I explored relationships between SAT Scores and Demographic Factors in NYC High Schools to analyze the efficacy of the SAT among different demographic groups. I used Python to read in the various datasets, cleaned them and then combined them into one dataset for analysis. Discovered that there was a Pearson R^2 correlation between percentage of white students and Higher SAT Scores of 0.62
